...
const CardSpeciality = ({name, imageUrl, description, onSelectSpeciality, toggleModal}) =>
{
    ...
    return (
        <>
            <div className={`w-[120px] h-[120px] md:w-[170px] md:h-[170px] lg:w-[200px] lg:h-[200px] xl:w-[200px] xl:h-[200px] xl:m-5 rounded-md relative m-2 md:m-5 xl:m-5 shadow-md ${styles.cardSpeciality}`} onClick={handlerClick}>
